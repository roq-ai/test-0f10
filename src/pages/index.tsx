  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Test - Your ultimate solution for customer data management. Simplify your work, organize customer details, and assign activities efficiently."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1599658880436-c61792e70672?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjdXN0b21lciUyMGRhdGF8ZW58MHx8fHwxNjk0MjkwNzE1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Test - Your ultimate solution for customer data management. Simplify your work, organize customer details, and assign activities efficiently.`}
            </Text>
            <Box
