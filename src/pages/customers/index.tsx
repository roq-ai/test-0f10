...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCustomers({
        relations: ['organization', 'activity.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('activity', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'activity',
          header: 'Activity',
          accessorKey: 'activity',
          cell: ({ row: { original: record } }: any) => record?._count?.activity,
        }
      : null,
